...
// EXTERNAL MODULE: ./node_modules/mini-css-extract-plugin/dist/loader.js??ruleSet[1].rules[4].use[1]!./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[4].use[2]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[4].use[3]!./node_modules/swiper/swiper-bundle.min.css
var swiper_bundle_min = __webpack_require__(159);
...
var update = injectStylesIntoStyleTag_default()((swiper_bundle_min_default()), options);
       ...
       /* harmony default export */ const swiper_swiper_bundle_min = ((swiper_bundle_min_default()) && (swiper_bundle_min_default()).locals ? (swiper_bundle_min_default()).locals : undefined);

// EXTERNAL MODULE: ./node_modules/mini-css-extract-plugin/dist/loader.js??ruleSet[1].rules[4].use[1]!./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[4].use[2]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[4].use[3]!./src/css/style.css
var style = __webpack_require__(604);
...
core.use(modules);
;// CONCATENATED MODULE: ./src/js/mainSlider.js

function initMainSlider() {
  new core(".js-main-slider", {
    spaceBetween: 30,
    slidesPerView: '2.5',
    navigation: {
...
function initMap() {
  ...
  function init() {
    let MyBalloonContentLayoutClass = ymaps.templateLayoutFactory.createClass('<div class="map__balloonContent" >' + '<h3>Наш адрес</h3>' + '<p>Санкт-Петербург,<br>Владимирский проспект, 23, <br>лит. А, офис 701</p>' + '<a href="#">Схема проезда</a>' + '</div>');
...
;// CONCATENATED MODULE: ./src/js/info.js
function initInfo() {
